      ...
      >
        ...
        {clueExpanded && (
          <div className="px-4 pb-3">
            {/* Image */}
            <div className="relative w-full h-48 rounded-lg overflow-hidden mb-3 bg-dark-card border border-dark-border">
              <div className="absolute top-2 right-2 z-10 text-[8px] uppercase tracking-[0.2em] text-cyan/40 font-bold border border-cyan/20 px-1.5 py-0.5 rounded-sm bg-dark-bg/60">
                Intel
              </div>
              {!imageLoaded && (
